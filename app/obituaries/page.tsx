  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="pt-0">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {obituaries.map((obituary, index) => (
                <div key={index} className="bg-blue-50 rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 border border-blue-200 card-hover">
        ...
        <section ref={submitRef} className="py-20 bg-blue-50 fade-in-up">
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-2xl mx-auto">
              <form action={submitObituaryForm} className="bg-blue-50 p-8 rounded-lg shadow-lg border border-blue-300 space-y-6">
                <div>
                ...
                <div className="text-center">
                  <button type="submit" className="bg-secondary text-white px-8 py-3 rounded-md hover:bg-primary-dark transition-colors duration-300 card-hover">Submit Obituary</button>
                </div>
              </form>
            </div>
          </div>
