...
export default function Contact() {
  const touchRef = useScrollAnimation()
  const messageRef = useScrollAnimation()
  const locationsRef = useScrollAnimation()
  return (
    <div className="min-h-screen">
      ...
      <main className="pt-0">
        ...
        <section ref={touchRef} className="py-20 fade-in-up">
          <div className="container mx-auto px-4">
            <h2 className="text-4xl font-bold text-center mb-16" style={{color: '#1030e6'}}>Get In Touch</h2>
        ...
        <section ref={messageRef} className="py-20  fade-in-up" style={{backgroundColor:'#E6F7FF'}}>
          <div className="container mx-auto px-4">
            <h2 className="text-4xl font-bold text-center mb-16" style={{color: '#1030e6'}}>Send Us a Message</h2>
            <div className="max-w-2xl mx-auto">
              <form action={submitContactForm} className="space-y-6 bg-blue-50">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label htmlFor="first-name" className="block text-sm font-medium text-gray-700 mb-2">First Name:</label>
                    <input type="text" id="first-name" name="first-name" required className="w-full px-4 py-2 border border-blue-200 rounded-md focus:ring-2 focus:ring-primary focus:border-transparent" />
                  </div>
                  <div>
                    <label htmlFor="last-name" className="block text-sm font-medium text-gray-700 mb-2">Last Name:</label>
                    <input type="text" id="last-name" name="last-name" required className="w-full px-4 py-2 border border-blue-200 rounded-md focus:ring-2 focus:ring-primary focus:border-transparent" />
                  </div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <input type="tel" id="phone" name="phone" className="w-full px-4 py-2 border border-blue-200 rounded-md focus:ring-2 focus:ring-primary focus:border-transparent" />
                </div>
                <div>
                  <label htmlFor="subject" className="block text-sm font-medium text-gray-700 mb-2">Subject:</label>
                  <select id="subject" name="subject" required className="w-full px-4 py-2 border border-blue-200 rounded-md focus:ring-2 focus:ring-primary focus:border-transparent">
                ...
                <div>
                  ...
                  <textarea id="message" name="message" rows={6} required className="w-full px-4 py-2 border border-blue-200 rounded-md focus:ring-2 focus:ring-primary focus:border-transparent"></textarea>
                </div>
                <div className="text-center">
                  <button type="submit" className="bg-secondary text-white px-8 py-3 rounded-md hover:bg-primary-dark transition-colors duration-300 card-hover">Send Message</button>
                </div>
              </form>
            </div>
          </div>
        ...
        <section ref={locationsRef} className="py-20 fade-in-up">
          <div className="container mx-auto px-4">
            <h2 className="text-4xl font-bold text-center mb-16" style={{color: '#1030e6'}}>Our Locations</h2>
            ...
            <div className="text-center border border-blue-200">
              ...
              <div className=" bg-blue-50 p-6 rounded-lg inline-block border border-blue-200 pulse-glow1">
