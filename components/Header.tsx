        ...
        {isMenuOpen && (
          <div className="md:hidden py-4 border-t border-gray-300">
            <nav className="flex flex-col space-y-2 px-4">
              <Link href="/" className="py-3 px-4 rounded-md hover:bg-gray-100 hover:text-[#E2A16F] hover:scale-105 transition-all duration-300 font-bold text-base" style={{color: '#E2A16F'}}>
                Home
              </Link>
              <Link href="/about" className="py-3 px-4 rounded-md hover:bg-gray-100 hover:text-[#E2A16F] hover:scale-105 transition-all duration-300 font-bold text-base" style={{color: '#E2A16F'}}>
                About Us
              </Link>
              <Link href="/services" className="py-3 px-4 rounded-md hover:bg-gray-100 hover:text-[#E2A16F] hover:scale-105 transition-all duration-300 font-bold text-base" style={{color: '#E2A16F'}}>
                Services
              </Link>
              <Link href="/pricing" className="py-3 px-4 rounded-md hover:bg-gray-100 hover:text-[#E2A16F] hover:scale-105 transition-all duration-300 font-bold text-base" style={{color: '#E2A16F'}}>
                Pricing
              </Link>
              <Link href="/ekijja-omanyi" className="py-3 px-4 rounded-md hover:bg-gray-100 hover:text-[#E2A16F] hover:scale-105 transition-all duration-300 font-bold text-base" style={{color: '#E2A16F'}}>
                Ekijja Omanyi
              </Link>
              <Link href="/obituaries" className="py-3 px-4 rounded-md hover:bg-gray-100 hover:text-[#E2A16F] hover:scale-105 transition-all duration-300 font-bold text-base" style={{color: '#E2A16F'}}>
                Obituaries
              </Link>
              <Link href="/gallery" className="py-3 px-4 rounded-md hover:bg-gray-100 hover:text-[#E2A16F] hover:scale-105 transition-all duration-300 font-bold text-base" style={{color: '#E2A16F'}}>
                Gallery
              </Link>
              <Link href="/contact" className="py-3 px-4 rounded-md hover:bg-gray-100 hover:text-[#E2A16F] hover:scale-105 transition-all duration-300 font-bold text-base" style={{color: '#E2A16F'}}>
                Contact
              </Link>
            </nav>
          </div>
